...
},{}],"C:\\wamp64\\www\\portfolios2\\src\\js\\main.js":[function(require,module,exports){
"use strict";
...
var Project = function () {
	...
	_createClass(Project, [{
		...
		key: "ProjectImg",
		value: function ProjectImg(src) {
			var url = "imgs/" + src + ".jpg";
		...
		value: function ProjectHover() {
			...
			var hoverLink = function hoverLink(e) {
				_this.link.removeClass('link-hover');
				var elem = $(e.currentTarget);
				elem.addClass('link-hover');
				_this.ProjectImg(elem.data('id'));
			};
